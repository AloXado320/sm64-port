...
#   f3dex   -
#   f3dex2  -
#   f3dex2e - custom version of f3dex2 for PC Port
...
else ifeq ($(GRUCODE),f3dex2e) # Fast3DEX2 Extended - PC
  DEFINES += F3DEX_GBI_2E=1 F3DEX_GBI_2=1 F3DEX_GBI_SHARED=1
...
SRC_DIRS := src src/engine src/game src/audio src/menu src/buffers actors levels bin data assets sound
ifeq ($(TARGET_N64),1)
  SRC_DIRS := $(SRC_DIRS) asm lib
else
...
# Compiler Options                                                             #
#==============================================================================#
INCLUDE_DIRS          := -I include -I $(BUILD_DIR) -I $(BUILD_DIR)/include -I src -I .
...
CC_CHECK := $(CC) -fsyntax-only -fsigned-char $(INCLUDE_DIRS) -Wall -Wextra -Wno-format-security -D_LANGUAGE_C $(C_DEFINES) $(PLATFORM_CFLAGS) $(GFX_CFLAGS)
CFLAGS := $(OPT_FLAGS) $(INCLUDE_DIRS) -D_LANGUAGE_C $(C_DEFINES) $(PLATFORM_CFLAGS) $(GFX_CFLAGS) -fno-strict-aliasing -fwrapv -march=native
